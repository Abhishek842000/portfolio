...
- `src/content/projects.ts` — ClaimGuard and Waypoint
- `src/content/publications.ts` — empty until real papers exist
...
Vercel, default Next.js settings. Set `NEXT_PUBLIC_SITE_URL` to the canonical domain.
